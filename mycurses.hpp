...
//todo: remove unnecessary fields, make Layout more abstract
...
public:
	...
	virtual bool respondToKeyPress(int ch) = 0;
	virtual void moveAndResize(int x, int y, int width, int height) = 0;
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class DialogContinueButton : public Component{
	bool finished = false;
public:
...
//child classes handle logic in constructor and destructor
...
public:
	...
	void drawComponents();
	int getChar();
	void addComponent(Component*); //calls addComponent(c, 0)
	void addComponent(Component*, unsigned char flags);
